    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
      <Card className="max-w-2xl w-full text-center border-2 border-primary/20 shadow-soft">
        <CardHeader className="pb-4">
          ...
          <CardTitle className="text-3xl sm:text-4xl font-bold text-foreground">Terms of Service</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-lg text-muted-foreground leading-relaxed">
            This page is still under development. We're working hard to create comprehensive terms of service for you.
          </p>
